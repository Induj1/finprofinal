        ...
        <div className="container-custom max-w-4xl">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            <div className="prose max-w-none">
              ...
              <h3 className="font-semibold mt-4 mb-2">Personal Identifiable Information</h3>
              <p>We may collect personal-identifiable information such as Your name and emails address to enable Your access to the Platform and services/products offered therein. We will collect personal-identifiable information from You only if such information is voluntarily submitted by You to us. You can always refuse to provide such personal identification information; however, it may prevent You from accessing services or products provided on the Platform or from engaging in certain activities on the Platform.</p>

              <h3 className="font-semibold mt-4 mb-2">Non-Personal Identifiable Information</h3>
              <p>When You interact with our Platform, we may collect non-personal-identifiable information such as the browser name, language preference, referring site, and the date and time of each user request, operating system and the Internet service providers utilized and other similar information.</p>

              <h3 className="font-semibold mt-4 mb-2">Cookies</h3>
              <p>To enhance User experience, our Platform may use 'cookies'. A cookie is a string of information that a website stores on a visitor's computer, and that the visitor's browser provides to the website each time the visitor returns for record-keeping purposes. You may choose to set Your web browser to refuse cookies, or to notify You when cookies are being sent; however, please note that in doing so, some parts of the Platform may not function properly.</p>

              <h2 className="text-xl font-bold mt-6 mb-3 text-finpro-red">HOW WE USE AND SHARE THE INFORMATION COLLECTED</h2>
              <p>We may collect and use Your Personal Information for the following purposes:</p>

              <h3 className="font-semibold mt-4 mb-2">To provide access to our Platform and/or the services/products offered therein</h3>
              <p>We use the Your information as collected by us to allow You to access the Platform and the services/products offered therein, including without limitation to provide customer service, fulfil purchases through the Platform, verify User information and to resolve any glitches with our Platform. The legal basis for this processing is consent or, where applicable, our legitimate interests in the proper administration of our Platform, and/or the performance of a contract between You and us.</p>

              <h3 className="font-semibold mt-4 mb-2">To improve our Platform and maintain safety</h3>
              <p>We use Your information to improve and customize the Platform and services/products offered by us. Further, we also use Your information to prevent, detect, investigate, and take measures against criminal activity, fraud, misuse of or damage to our Platform or network, and other threats and violations to a third party's or our rights and property, or the safety of our Users, or others. The legal basis for this processing is consent or, where applicable, our legitimate interests in the proper administration of our Platform, and/or the performance of a contract between You and us.</p>

              <h3 className="font-semibold mt-4 mb-2">To communicate with You or market our services/products</h3>
              <p>We may use the email address submitted by You to communicate with You about Your orders on our Platform, our offers, new products, services or even receive Your feedback on the Platform or any services/products offered therein. It may also be used to respond to Your inquiries, questions, and/or other requests. If at any time You would like to unsubscribe from receiving future emails, please write to us at the contact information provided below. The legal basis for this processing is consent or, where applicable, our legitimate interests in the proper administration of our Platform, and/or the performance of a contract between You and us.</p>

              <p>We do not use Personal Information for making any automated decisions affecting or creating profiles other than what is described in this Policy.</p>

              <p>We do not sell, trade, or otherwise exploit Your personal-identifiable information to others. Limited to the purposes stated hereinabove, we may share generic aggregated demographic information not linked to any personal-identifiable information regarding visitors and Users with our business partners and trusted affiliates.</p>

              <h2 className="text-xl font-bold mt-6 mb-3 text-finpro-red">YOUR CHOICES</h2>
              <h3 className="font-semibold mt-4 mb-2">Limit the information You provide</h3>
              <p>You always have an option to choose the information You provide to us, including the option to update or delete Your information. However, please note that lack of certain information may not allow You access to the Platform or any of its features, in part or in full. For example: information required for Your registration on the Platform.</p>

              <h3 className="font-semibold mt-4 mb-2">Limit the communications You receive from us</h3>
              <p>Further, You will also have the option to choose what kind of communication You would like to receive from us. However, there may be certain communications that are required for legal or security purposes, including changes to various legal agreements, that you may not be able to limit.</p>

              <h3 className="font-semibold mt-4 mb-2">Reject Cookies and other similar technologies</h3>
              <p>You may reject or remove cookies from Your web browser; You will always have the option to change the default settings on Your web browser if the same is set to 'accept cookies'. However, please note that some of the services/products offered on the Platform may not function or be available to You, when the cookies are rejected, removed or disabled.</p>

              <h2 className="text-xl font-bold mt-6 mb-3 text-finpro-red">YOUR RIGHTS</h2>
              <p>In general, all Learners have the rights specified herein this section. However, depending on where you are situated, you may have certain specific rights in respect of your Personal Information accorded by the laws of the country you are situated in. To understand Your rights, please refer to the Country Specific Additional Rights below.</p>

              <p>If you are a Learner, you may exercise any of these rights by using the options provided to you within the Platform upon your login. If however, you are facing any issues or require any clarifications, you can always write to us at the address noted in the 'Grievances' section below, and we will address your concerns to the extent required by the applicable law.</p>

              <h3 className="font-semibold mt-4 mb-2">Right to Confirmation and Access</h3>
              ...
              <h3 className="font-semibold mt-4 mb-2">Right to Correction</h3>
              ...
              <h3 className="font-semibold mt-4 mb-2">Right to be Forgotten</h3>
              ...
              <h3 className="font-semibold mt-4 mb-2">Right to Erasure</h3>
              ...
              <p>Remember, you are entitled to exercise your rights as stated above only with respect to your information, including Personal Information, and not that of other Learners. Further, when we receive any requests or queries over email to the address specified in the 'Grievances' section below, then, as per the applicable Data Protection Laws, we may need to ask you a few additional information to verify your identity in association with the Platform and the request received.</p>

              <h2 className="text-xl font-bold mt-6 mb-3 text-finpro-red">PROTECTION OF YOUR INFORMATION</h2>
              ...
              <p>To the extent permitted by law, we will attempt to give You prior notice before disclosing Your information in response to such a request.</p>

              <h2 className="text-xl font-bold mt-6 mb-3 text-finpro-red">THIRD PARTY WEBSITES</h2>
              ...
              <h2 className="text-xl font-bold mt-6 mb-3 text-finpro-red">CROSS-BORDER DATA TRANSFER</h2>
              ...
              <p>Note: If you wish to exercise any of your rights (as specified in 'Your Rights' section below) to access, modify and delete any or all information stored about you, then you may do so by using the options provided within the Platform. You can always write to us at the email address specified in the 'Grievances' section below</p>

              <h2 className="text-xl font-bold mt-6 mb-3 text-finpro-red">MODIFICATION TO PRIVACY POLICY</h2>
              ...
              <h2 className="text-xl font-bold mt-6 mb-3 text-finpro-red">GRIEVANCES</h2>
              <p>If you have any questions about this Policy, wish to exercise your rights, concerns about privacy or grievances, please write to us with a thorough description via email to <a href="mailto:indiafinpro@gmail.com" className="text-finpro-red hover:underline">indiafinpro@gmail.com</a>.</p>

              <h2 className="text-xl font-bold mt-6 mb-3 text-finpro-red">COUNTRY SPECIFIC ADDITIONAL RIGHTS</h2>
              <h3 className="font-semibold mt-4 mb-2">TERMS APPLICABLE IF YOU ARE AN INDIAN RESIDENT</h3>
              <p>Your Rights: If you are located in India, you may have the following rights under the Personal Data Protection Bill (PDPB) when it becomes a legislation. All requests can be made by using the option provided to you within the Platform upon your login. You may also write to us as stated in the "Grievances" section above, and we will address you concerns to the extent required by law.</p>

              <h4 className="font-medium mt-2 mb-1">Right to Confirmation and Access</h4>
              <p>You have the right to get confirmation and access to your Personal Information that is with us along with other supporting information.</p>

              <h4 className="font-medium mt-2 mb-1">Right to Correction</h4>
              <p>You have the right to ask us to rectify your Personal Information that is with us that you think is inaccurate. You also have the right to ask us to update your Personal Information that you think is incomplete or out-of-date.</p>

              <h4 className="font-medium mt-2 mb-1">Right to Data Portability</h4>
              <p>You have the right to ask that we transfer the Personal Information you gave us to another organisation, or to you, under certain circumstances.</p>

              <h4 className="font-medium mt-2 mb-1">Right to be Forgotten</h4>
              <p>You have the right to restrict or prevent the continuing disclosure of your Personal Information under certain circumstances.</p>

              <h4 className="font-medium mt-2 mb-1">Right to Erasure</h4>
              <p>If you wish to withdraw/remove your Personal Information from our Platform, you have the right to request erasure of your Personal Information from our Platform. However, please note that such erasure will remove all your Personal Information from our Platform (except as specifically stated in this Policy) and may result in deletion of your account on the Platform permanently, and the same will not be retrievable.</p>

              <h3 className="font-semibold mt-4 mb-2">TERMS APPLICABLE IF YOU ARE A RESIDENT OF UNITED KINGDOM (UK), A EUROPEAN UNION (EU) COUNTRY OR EUROPEAN ECONOMIC AREA (EEA)</h3>
              <p>Your Rights: If you are located in the United Kingdom (UK) or European Union (EU) or European Economic Area (EEA), you have the following rights under the UK and EU General Data Protection Regulation (GDPR) respectively. All requests should be sent to the address noted in the "Grievances" section above, and we will fulfil requests to the extent required by applicable law.</p>

              <h4 className="font-medium mt-2 mb-1">Right to access Your Personal Information</h4>
              <p>You have the right to receive confirmation as to whether or not Personal Information concerning you is being processed and, where that is the case, access to the Personal Information can be sought;</p>

              <h4 className="font-medium mt-2 mb-1">Right to Rectification</h4>
              <p>Our goal is to keep your Personal Information accurate, current and complete. Please contact us if you believe your information is inaccurate or incomplete;</p>

              <h4 className="font-medium mt-2 mb-1">Right to Erasure</h4>
              <p>In some cases, you have a legal right to request that we erase your Personal Information;</p>

              <h4 className="font-medium mt-2 mb-1">Right to object to Processing</h4>
              <p>You have the right to object to our processing of your Personal Information under certain conditions;</p>

              <h4 className="font-medium mt-2 mb-1">Right to restrict Processing</h4>
              ...
              <h4 className="font-medium mt-2 mb-1">Right to make a complaint to a government supervisory authority</h4>
              <p>If you believe we have not processed your Personal Information in accordance with applicable provisions of the GDPR, we encourage you to contact us at email address provided in the 'Grievances' section above. You also have the right to make a GDPR complaint to the relevant Supervisory Authority or seek a remedy through the courts. A list of Supervisory Authorities is available at: https://edpb.europa.eu/about-edpb/board/members_en. If you need further assistance regarding your rights, please contact us using the contact information provided below, and we will consider your request in accordance with applicable law. You can identify the supervising authority of your concern by visiting https://edpb.europa.eu/about-edpb/board/members_en.</p>

              <h4 className="font-medium mt-2 mb-1">Right to not be subject to automated decision-making, including profiling</h4>
              <p>You have the right not to be subject to a decision based solely on automated processing, including profiling, which produces legal or similarly significant effects concerning you.</p>

              <p>We collect and process Personal Information about you only where we have a legal rationale to do so. Specific legal rationale applied for the same will depend on the type of Personal Information collected and the context in which the same is being processed, including the Services involved.</p>

              <h3 className="font-semibold mt-4 mb-2">TERMS APPLICABLE IF YOU ARE A CALIFORNIA STATE RESIDENT</h3>
              ...
              <p>The above rights, the manner in which you can exercise the same and the category of and the manner in which we collect your information, are detailed below.</p>

              <h4 className="font-medium mt-2 mb-1">CCPA NOTICE AT COLLECTION</h4>
              <p>For purposes of the CCPA, in collecting the information described above, we collect the categories of Personal Information listed below from you:</p>

              <h5 className="italic mt-1">Identifiers</h5>
              <p>We may collect your name, email address, mobile number, username, unique personal identifier, and Internet Protocol (IP) address. We use Identifiers as set forth in the "How We Use and Share the Information Collected" section of this Policy, like your name, contact information, and device and online identifiers.</p>

              <h5 className="italic mt-1">Characteristics of Personal Information described in the California Customer Records statute</h5>
              <p>We may collect your name, email address, username, unique personal identifier, and gender. We use Categories of Personal Information described in the California Consumer Records statute as set forth in the 'How We Use and Share the Information Collected' section of this Policy.</p>

              <h5 className="italic mt-1">Internet or other electronic network activity information</h5>
              <p>We collect cookies as described above, we will automatically receive information from your browser and your device, which includes the date and time of your visit to the Platform as well as your location, Internet Protocol (IP) address, domain server, browser type, access time, and data about which pages you visit on the Platform. We use Internet or other electronic network activity information as set forth in the "How We Use and Share the Information Collected" section of this Policy.</p>

              <h5 className="italic mt-1">Geolocation data</h5>
              <p>We may collect your IP address. We may use Geolocation Data as set forth in the "How We Use and Share the Information Collected" section of this Policy.</p>

              <h5 className="italic mt-1">Audio, electronic, visual or similar information</h5>
              <p>We may collect your profile picture or other audio or visual information uploaded as content to the Platform. We use audio, electronic, visual or similar information as set forth in the "How We Use and Share the Information Collected" section of this Policy.</p>

              <h5 className="italic mt-1">Inferences</h5>
              <p>We may make inferences based upon the Personal Information collected (such as likelihood of retention or attrition). We use Inference information as set forth in the "How We Use and Share the Information Collected" section of this Policy.</p>

              <h4 className="font-medium mt-2 mb-1">CCPA DATA PRACTICES DURING THE LAST 12 MONTHS</h4>
              <p>Personal Information collected: As described in this Policy, we have collected the categories of Personal Information listed below during the preceding 12 months:</p>
              <ul className="list-disc pl-6 mb-4">
                <li>Identifiers</li>
              ...
              <p>Categories of sources: We have collected the Personal Information identified in this Policy from you and our payment processors.</p>

              <p>Business and commercial purposes for collecting: We have collected the categories of Personal Information listed above for the following purposes:</p>
              <ul className="list-disc pl-6 mb-4">
              ...
              <p>Personal Information sold: We have not sold categories of Personal Information during the preceding 12 months.</p>

              <p>Personal Information disclosed for a business purpose: We have disclosed for a business purpose the categories of Personal Information listed below during the preceding 12 months:</p>
              <ul className="list-disc pl-6 mb-4">
                <li>Identifiers</li>
                <li>Characteristics of Personal Information described in the California Customer Records statute</li>
                <li>Internet or other electronic network activity information</li>
              ...
              <h4 className="font-medium mt-2 mb-1">CCPA Non-Discrimination</h4>
            ...
            <div className="mt-8 text-center">
              <p>For any questions regarding our Privacy Policy, please contact:</p>
              <a href="mailto:indiafinpro@gmail.com" className="text-finpro-red hover:underline">
