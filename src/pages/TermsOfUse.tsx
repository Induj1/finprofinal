    ...
    <>
      ...
      <div className="bg-gray-50 py-16">
        <div className="container-custom max-w-4xl">
          <h1 className="text-3xl md:text-4xl font-montserrat font-bold mb-8 text-center">Terms of Use</h1>
          
          <div className="bg-white p-8 rounded-lg shadow-md">
            <div className="prose max-w-none">
              <p>These Terms of Use set out the terms and conditions for use of this FINPRO ( "Website") and any content, Public Forums, or services offered on or through the Website and/or through any mobile application(s) ( "Application") (collectively referred to as the "Platform").</p>

              <p>These Terms of Use apply to end users of the Website (referred to as "Learners", "You", "Your"). These Terms of Use, including the Privacy Policy and any other terms and conditions published on the Platform or communicated to you from time to time (collectively referred to as the "Agreement"), define the relationship and responsibilities between You and Creator (as defined herein) in using the Platform. Your access to the Platform is subject to Your acceptance of this Agreement. Hence, please take Your time to read this Agreement.</p>

              <p>When we speak of "Creator", 'we', 'us', and 'our', we collectively mean FINPRO being the creator of this Platform and the content/materials/services contained therein.</p>
              ...
              <ul className="list-disc pl-6 mb-4">
                ...
                <li>transfer the any material made available on the Platform to another person or 'mirror' the same on any other server.</li>
              </ul>

              <p>For the purpose of this Agreement, "Creator Content" shall mean and include any audio files, video files, audio-visual files, images, text materials (including .doc, .docx, and .pdfs) (other than the Content) uploaded or otherwise published on the Platform by the Creator to be accessed by You, including, but not limited to any such content/material posted by the Creator in any Public Forum (defined below).</p>
              ...
              <h2 className="text-xl font-bold mt-6 mb-3 text-finpro-red">Indemnity and Release</h2>
              <p>You shall indemnify and hold harmless the Creator and where applicable, its officers, directors, agents and employees, from any claim or demand, or actions including reasonable attorney's fees, made by any third party or penalty imposed due to or arising out of Your breach of this Agreement or any document incorporated by reference, or Your violation of any law, rules, regulations or the rights of a third party.</p>

              <h2 className="text-xl font-bold mt-6 mb-3 text-finpro-red">Links to Third Party Website</h2>
              <p>Creator has not reviewed all of the sites linked to its Platform and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by the Creator of such site. Use of any such linked website is at the Your own risk.</p>

              <h2 className="text-xl font-bold mt-6 mb-3 text-finpro-red">Governing Law and Jurisdiction</h2>
              ...
              <h2 className="text-xl font-bold mt-6 mb-3 text-finpro-red">Miscellaneous</h2>
              <h3 className="font-semibold mt-4 mb-2">Alteration of Platform or Amendments to the Conditions</h3>
              <p>We reserve the right to make changes to our Platform, policies, and this Agreement at any time. We will post the new terms with a revision date indicated at the top or if deemed practicable. You should check our Platform frequently to see recent changes. You will be subject to the Agreement and the policies in force at the time that You use the Platform or any part thereof, unless any change to those policies or these conditions is required to be made by law or government authority (in which case it will apply to orders previously placed by You). If any of these conditions is deemed invalid, void, or for any reason unenforceable, that condition will be deemed severable and will not affect the validity and enforceability of any remaining condition.</p>

              <h3 className="font-semibold mt-4 mb-2">Waiver</h3>
              ...
              <h3 className="font-semibold mt-4 mb-2">Assignment</h3>
              <p>You may not assign or transfer this Agreement, by operation or law or otherwise. Any attempt by You to assign or transfer this Agreement will be null and void.</p>

              <h3 className="font-semibold mt-4 mb-2">Severability</h3>
              <p>If any provision of this Agreement will be adjudged by any court of competent jurisdiction to be unenforceable or invalid, that provision will be limited to the minimum extent necessary so that this Agreement will otherwise remain in effect.</p>

              <h3 className="font-semibold mt-4 mb-2">Events beyond our reasonable control</h3>
              ...
              <h2 className="text-xl font-bold mt-6 mb-3 text-finpro-red">Contact Us</h2>
              <p>If You've have concerns or queries regarding this Agreement, You may write to us by email at <a href="mailto:indiafinpro@gmail.com" className="text-finpro-red hover:underline">indiafinpro@gmail.com</a>.</p>
            </div>
            
            <div className="mt-8 text-center">
              <p>For any questions regarding our Terms of Use, please contact:</p>
